...
- The http link to the location of faces in the object storage  : http://169.45.121.163:8000/May_18_02_07/  
  The above webserver runs out of VSI, that serves the given directory from the mounted object storage.
- This is the link corresponding to the ibm object storage : https://s3.us-east.cloud-object-storage.appdomain.cloud/cos1-cos-standard-skk1
